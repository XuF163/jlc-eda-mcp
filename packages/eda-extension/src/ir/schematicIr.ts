...
const PageSchema = z
	.object({
		...
		clearMode: z.enum(['mcp', 'all']).optional().default('mcp'),
	})
	.optional();
...
const ConnectionSchema = z.object({
	...
	net: z.string().min(1).optional(),
	style: z.enum(['manhattan', 'straight']).optional().default('manhattan'),
...
const PostSchema = z
	.object({
		...
		zoomToAll: z.boolean().optional().default(false),
		capturePng: z
			.object({
...
export const SchematicIrSchema = z.object({
	...
	netFlags: z.array(NetFlagSchema).optional().default([]),
	netPorts: z.array(NetPortSchema).optional().default([]),
	texts: z.array(TextSchema).optional().default([]),
	wires: z.array(WireSchema).optional().default([]),
